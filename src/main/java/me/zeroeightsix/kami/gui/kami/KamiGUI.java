...
import me.zeroeightsix.kami.module.modules.development.XpCount;
import me.zeroeightsix.kami.module.modules.development.CrystalCount;
...
public class KamiGUI extends GUI {
    ...
    public void initializeGUI() {
        ...
        frame = new Frame(getTheme(), new Stretcherlayout(1), "Item Info");
        frame.setCloseable(false);
        frame.setPinneable(true);
        ...
        information.addTickListener(() -> {
            information.setText("");
            information.addLine("\u00A74 " + KamiMod.KAMI_KANJI + "\u00A74 " + KamiMod.MODVER);
            information.addLine("\u00A74 " + "Crystals " + CrystalCount.crystals);
            information.addLine("\u00A74 " + "XP " + XpCount.xpbottle);

            class CrystalCount extends Module {
                int crystals;
